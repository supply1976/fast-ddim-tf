...
![CIFAR-10 samples generated by the current best net02 split](docs/assets/cifar10_net02_bs128_200k/cosine_noise_constant_100steps.png)

Sample grid from the current best CIFAR-10 split: `net02`, `cosine`,
`noise`, `constant`, batch size `128`, global steps `200k`. <br>
Reverse Steps `100`, FID `14.683969`.
...
| Scheduler | Prediction | Loss weight | net02 batch 128 | net01 batch 128 | net01 batch 32 |
| ---       | ---        | ---         | ---: | ---: | ---: |
| cosine | noise | constant | 14.683969 | 15.187247 | 19.006805 |
| cosine | velocity | constant | 15.076883 | 17.500657 | 24.998476 |
| linear | noise | constant | 16.716998 | 20.108495 | 25.263250 |
| linear | velocity | min_snr | 19.965122 | 21.881283 | 25.298657 |
| cosine | velocity | min_snr | 20.322766 | 18.514213 | 17.980634 |
| cosine | noise | min_snr | 20.341582 | 17.051221 | 17.636943 |
| linear | noise | min_snr | 20.579531 | 20.298217 | 23.677097 |
| linear | velocity | constant | 21.142146 | 26.984146 | 33.871343 |
